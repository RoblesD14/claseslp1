...
if ( isset ( $ _POST [ "operacion" ])) {
    ...
    switch ( $ _POST [ "operacion" ]) {
        caso  "Sumar" : Operaciones :: suma ( $ nro1 , $ nro2 );
            romper ;
        caso  "Restar" : Operaciones :: resta ( $ nro1 , $ nro2 );
            romper ;
        caso  "Multiplicar" : Operaciones :: multiplicacion ( $ nro1 , $ nro2 );
            romper ;
        caso  "Dividir" : Operaciones :: división ( $ nro1 , $ nro2 );
            romper ;
    }
}
